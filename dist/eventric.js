...
Eventric = (function() {
  function Eventric() {
    ...
    this.projectionService = new this.Projection(this);
    this._contexts = {};
    this._params = {};
...
require.register("eventric/logger", function(exports, require, module){
  module.exports = {
  _logLevel: 1,
...
Context = (function() {
  function Context(name, _eventric) {
    ...
    this.projectionService = this._eventric.projectionService;
...
Projection = (function() {
  ...
  * @param {Function|Object} Projection Function or Object containing a ProjectionDefinition
  ...
  Projection.prototype.initializeInstance = function(projectionName, Projection, params, _context) {
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        _this.log.debug("[" + _this._context.name + "] Clearing ProjectionStores of " + projectionName);
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        return _this._eventric.eachSeries(projection.stores, function(projectionStoreName, next) {
          ...
          return _this._context.getProjectionStore(projectionStoreName, projectionName, function(err, projectionStore) {
            if (projectionStore) {
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        return _this._eventric.eachSeries(projectionStores, function(projectionStoreName, next) {
          ...
          return _this._context.clearProjectionStore(projectionStoreName, projectionName, function() {
  ...
  Projection.prototype._subscribeProjectionToDomainEvents = function(projectionId, projectionName, projection, eventNames, aggregateId, domainEventStreamName) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        var domainEventHandler, eventName, subscriberId, _base, _base1, _i, _len;
        ...
        if (domainEventStreamName) {
          subscriberId = _this._context.subscribeToDomainEventStream(domainEventStreamName, domainEventHandler, {
            isAsync: true
          });
          ...
          for (_i = 0, _len = eventNames.length; _i < _len; _i++) {
            ...
            if (aggregateId) {
              subscriberId = _this._context.subscribeToDomainEventWithAggregateId(eventName, aggregateId, domainEventHandler, {
                isAsync: true
              });
            } else {
              subscriberId = _this._context.subscribeToDomainEvent(eventName, domainEventHandler, {
                isAsync: true
              });
            }
            if ((_base1 = _this._handlerFunctions)[projectionId] == null) {
              _base1[projectionId] = [];
            }
            _this._handlerFunctions[projectionId].push(subscriberId);
          }
  ...
  * @param {Object} context Context Instance so we can automatically unsubscribe the Projection from DomainEvents
  ...
  Projection.prototype.destroyInstance = function(projectionId) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      this._context.unsubscribeFromDomainEvent(subscriberId);
    }
...
Remote = (function() {
  ...
  * @param {Object} params Object containing Projection Parameters
  ...
  Remote.prototype.initializeProjection = function(projectionObject, params) {
    return this._eventric.projectionService.initializeInstance('', projectionObject, params, this);
  };
  ...
  * @param {Object} params Object containing Projection Parameters
  ...
  Remote.prototype.initializeProjectionInstance = function(projectionName, params) {
    ...
    return this._eventric.projectionService.initializeInstance(projectionName, this._projectionClasses[projectionName], params, this);
  };
  ...
  * @param {String} projectionId ProjectionId
  ...
  Remote.prototype.getProjectionInstance = function(projectionId) {
    return this._eventric.projectionService.getInstance(projectionId);
  };
  ...
  * @param {String} projectionId ProjectionId
  ...
  Remote.prototype.destroyProjectionInstance = function(projectionId) {
    return this._eventric.projectionService.destroyInstance(projectionId, this);
  };
